...
export default (
  ...
  */
  const languageNeutralSelectors = {
    ...
    integrationId: function grammar() { return this.state.integrationId; },
    grammar: function grammar() { return this.state.grammar; },
    primitives: function primitives() { return this.state.primitives; },
    keyToNewSynoAttrs: function keyToNewSynoAttrs() { return this.state.keyToNewSynoAttrs; },
    ...
    resultTree: function resultTree() { return this.state.resultTree; },
    ...
    loadingIntegration: function loadingIntegration() { return this.state.loadingIntegration; },
    ...
    // loaded
    treeLoaded: function treeLoaded() { return !!this.state.synoMap; },
    integrationLoaded: function integrationLoaded() { return !!this.state.integrationId; },
    // synos
