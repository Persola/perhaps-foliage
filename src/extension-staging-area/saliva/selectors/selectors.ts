...
export default {
  ...
  getFunctionDefinition: function getFunctionDefinition(functionDefinitionId: SynoId): FunctionDefinition {
  ...
  getFunctionParameter: function getFunctionParameter(functionParameterId: SynoId): FunctionParameter {
