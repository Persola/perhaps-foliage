...
export default ((state: StateSelector, integration: PresentLanguageIntegration, rootSynoId: SynoId, scope: {}, focus: Focus | null | undefined): Prestree => {
  const mutablePresnoMap: MutablePresnoMap = {};
  presentSyno(state, integration, mutablePresnoMap, null, state.getSyno(rootSynoId), scope, focus, presentSyno);
